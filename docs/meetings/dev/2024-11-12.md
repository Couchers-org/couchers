...
* What everyone's working on:
    ...
    - Aapeli: Thinking more about Couchers priorities, rearchitecting map backend, work on active as probing - emailing people to ask if still around. Went through most open bugs. This week also same.
    ...
    - Navi: Couldn't attend today, but send update that she’s started playing with the repo and did some research on how to write the workflow for abandoned tickets.
