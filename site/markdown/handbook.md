...
Send an email to [support@couchers.org](mailto:support@couchers.org) with as many details as possible. Please include a link and/or a screenshot of the content you are reporting if possible.
...
Currently you cannot leave a reference for someone you are not friends with. However, you can report the person or email [safety@couchers.org](mailto:safety@couchers.org).
