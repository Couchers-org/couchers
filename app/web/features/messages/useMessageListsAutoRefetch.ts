...
export default function useMessageListsAutoRefetch() {
  ...
  const unseenHostingHostRequestCount = notifications?.unseenHostingHostRequestCount;
  const unseenSurfingHostRequestCount = notifications?.unseenSurfingHostRequestCount;
