...
export default function DeleteDiscussionDialog({
  discussionId,
  ...props
}: DialogProps & { discussionId: number }) {
  ...
  return (
    <Dialog {...props} aria-labelledby="delete-discussion-dialog-title">
      <DialogTitle id="delete-discussion-dialog-title">
        {t("communities:delete_discussion_dialog.title")}
      </DialogTitle>
      <DialogContent>
        {deleteDiscussionMutation.error && (
          <Alert severity="error">
            {deleteDiscussionMutation.error?.message}
          </Alert>
        )}
        <DialogContentText>
          {t("communities:delete_discussion_dialog.message")}
        </DialogContentText>
      </DialogContent>
      <DialogActions>
        <Button
