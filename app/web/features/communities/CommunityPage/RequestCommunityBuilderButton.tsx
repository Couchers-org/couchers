...
export default function RequestCommunityBuilderButton({ community }: { community: Community.AsObject }) {
  ...
  return (
    <>
      ...
      />
      {showSuccess && (
        <Snackbar severity="success">{t("communities:request_community_builder_dialog.toast_success")}</Snackbar>
      )}
    </>
  );
}
