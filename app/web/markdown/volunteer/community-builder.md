...
- a [fully filled out profile](https://help.couchers.org/hc/couchersorg-help-center/articles/1725919197-how-do-i-create-a-great-profile) (including bio and photos).
- written comments on the community discussions page.
- hosted local events for members and travelers.
- actively invited new members to join and build up the local community.
- completed the Strong Verification (SV) process (i.e. have a [SV badge](https://couchers.org/badges/strong_verification)) to help maintain trust and security on the platform. (can be optional in special circumstances)
...
- Willingness to role-sharing/collaborate with the other CBs and CBPMs;
