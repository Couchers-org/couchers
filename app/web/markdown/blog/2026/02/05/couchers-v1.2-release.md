---
title: "Couchers 1.2 Release - Feature releases and mobile app!"
...
We've been silently working behind the scenes and have some big updates! First we want to let you know the results of our successful donation drive. We'll share some major features that have come out you can look for, and we're ready to take on beta testers for the Couchers.org mobile app!

- Donation Drive
- Couchers.org Merchandise Shop
- New Features
- Mobile App Beta Release
- Volunteer at Couchers - Help we need right now
...
We now have a shop where you can buy Couchers.org hats, hoodies, stickers, pins and flags!. [Check out the Couchers.org Merch Shop here.](https://shop.couchershq.org/). When you purchase merch, you'll get a "Swagster" badge on your profile too!
...
At long last you can upload multiple photos to your profile! This has been requested for ages and we've finally finished it up. For now this feature is only for users who complete the free strong verification.
...
In preparation for the mobile app, we released dark mode! You can find this in the top navigation bar and in account settings.
