...
![Screenshot of the redesigned landing page](/img/blog/20250701_landing_page.png)

We are really excited about our [new landing page](https://couchers.org), which clearly communicates what Couchers is, what we stand for, and what you can find on the platform once you sign up. We hope this will help us gain more of the right kinds of members!

A huge thanks to [Nicole](https://couchers.org/user/unsettleddown) who built the majority of the landing page; [Pablo](https://couchers.org/user/pcolt86) and [Aapeli](https://couchers.org/user/aapeli) who also helped build it; [Marta](https://couchers.org/user/marta) and [Charlotte](https://couchers.org/user/karottensaft1) who designed it; [Jesse](https://couchers.org/user/jesse) and [Chris](https://couchers.org/user/chrisk) who helped test it; and countless others who helped write or brainstorm our marketing message, or provided their input in other ways!
...
* you can now indicate whether you did not stay with or host someone (and we won't remind you to leave references); and

* you can now send our Safety Team private feedback (that's not shown on the public reference) about your interactions through the reference flow. You can use this functionality to let us know if something felt off, even if there's no cause for bigger concern. More information is always better and helps the Safety Team understand situations better and keep the platform safe!

Thanks to [Aapeli](https://couchers.org/user/aapeli), [Nicole](https://couchers.org/user/unsettleddown), and [Jason](https://couchers.org/user/jasonwvh) for these updates. [Nicole](https://couchers.org/user/unsettleddown) also added the number of references to the references tab on profiles to draw more attention to it.

### Find members faster: a new and redesigned map

![Screenshot of the new Map Search](/img/blog/20250701_map.png)

[Nicole](https://couchers.org/user/unsettleddown) spent months re-architecting and rebuilding a brand new Map Search page! The old one was creaking with age and very difficult to update and add features to. Nicole rewrote it from scratch! [Aapeli](https://couchers.org/user/aapeli) helped build some new backend functionality to significantly speed up searching, and [Jesse](https://couchers.org/user/jesse) among many others helped test it!
...
![Screenshot of the notification tray](/img/blog/20250701_notification_tray.png)
...
Thanks to [Aapeli](https://couchers.org/user/aapeli), [Rafael](https://couchers.org/user/rafael_ferreira) and [Yannic](https://couchers.org/user/spreeni) for the backend implementation; [Nicole](https://couchers.org/user/unsettleddown) for some frontend work; and [Jesse](https://couchers.org/user/jesse) and others for testing.

### Speaking your language: a new language selector & translations

![Screenshot of translation functionality with the platform in German](/img/blog/20250701_translated_german.png)

We implemented a language selector and are in the active process of translating the platform to languages other than English! Thanks to [Laura](https://couchers.org/user/ellebee), [Nicole](https://couchers.org/user/unsettleddown) and [Aapeli](https://couchers.org/user/aapeli) for their work on the functionality, as well as the many folks helping out on translation!

If you'd like to see the platform be translated to your own language, please apply to volunteer for our [Translator Position](https://couchers.org/volunteer/translator)! You can contribute as much or as little as you want. Every bit helps!

### Safety & Moderation

We have rolled out significant new functionality to make the platform safer:

* [Nicole](https://couchers.org/user/unsettleddown) and [Aapeli](https://couchers.org/user/aapeli) implemented functionality to remove friends;
* [Nicole](https://couchers.org/user/unsettleddown) built the frontend functionality to block (and unblock) users, while [Yannic](https://couchers.org/user/spreeni) helped fix up some lingering backend functionality for that;
* [Colleen](https://couchers.org/user/colleen) added report flags to event cards; and
* under the hood, [Aapeli](https://couchers.org/user/aapeli), [Jesse](https://couchers.org/user/jesse) and [Rafael](https://couchers.org/user/rafael_ferreira) continue to work on many different moderation and admin features to help combat abuse and make the platform safer for everyone!

We also updated our policies and now forbid [nudism](https://help.couchers.org/hc/couchersorg-help-center/articles/1746572895-why-is-nudism-naturism-nudity-clothing_optional-not-allowed-on-couchers-org) and [shared sleeping surfaces](https://help.couchers.org/hc/couchersorg-help-center/articles/1748816842-why-are-shared-beds-sleeping-surfaces-not-allowed) (such as a shared bed). The change was prompted by the significant moderation burden caused by regular issues with this subgroup of the community. This was a decision made by the Board in order to promote safety on the platform and to set clear expectations for everyone. Thanks to the volunteers who spearheaded this difficult change!
...
- [Translating Couchers into other languages](https://couchers.org/volunteer/translator)
- Help from mid-level and senior software engineers (who have 5+ hours per week to spare: [frontend](https://couchers.org/volunteer/frontend-developer)/[backend](https://couchers.org/volunteer/backend-developer))
- [Mid-level and senior engineers with React Native experience](https://couchers.org/volunteer/mobile-development-lead)
- [Writing blog posts and content around couch surfing](https://couchers.org/volunteer/blog-writer) (we could really use help to do this more regularly)
...
- [Community Builders](https://forms.monday.com/forms/1e84199578bc028b282a88b9e325d646?r=use1)  who want to help build the Couchers community in their own city or country

Apply via the links above or write us at [volunteers@couchers.org](mailto:volunteers@couchers.org) with how you'd like to help out!

### Hype us up on social media

Follow us on the socials, and like+share religiously 🙏

* [Instagram](https://www.instagram.com/couchersorg/)
* [Reddit](https://www.reddit.com/r/couchers/)
* [Bluesky](https://bsky.app/profile/couchers.bsky.social)
* [Facebook](https://www.facebook.com/Couchers.org)
