...
<table style="width: 100%; table-layout: fixed; border-collapse: separate; border-spacing: 3; border-radius: 5px; text-align: left; font-family: Ubuntu, sans-serif; font-size: 14px;">
  <thead>
    <tr style="background-color: #E47701; color: white; text-align: center;">
      <th colspan="6" style="padding: 10px; border-top-left-radius: 10px; border-top-right-radius: 10px;"><h1 style="font-size: 32px;margin:0">2026 Roadmap</h1></th>
    </tr>
    <tr style="background-color: #FDE9D4; text-align: center;">
      ...
      <th style="border: 0; padding: 8px; border-radius: 5px;">Q2 2026</th>
      <th style="border: 0; padding: 8px; border-radius: 5px;">Q3 2026</th>
      <th style="border: 0; padding: 8px; border-radius: 5px;">Q4 2026</th>
 ...
 <tbody>
  <!-- MILESTONES -->
    ...
    <tr >
	  <td colspan="3"</td>
      <td colspan="2" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;">TBC</td>
    </tr>
    <tr >
	  <td colspan="4"</td>
    ...
    <tr>
      <td colspan="5" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Photo Gallery</td>
    </tr>
    <tr>
      <td colspan="5" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Duplicate Events</td>
    </tr>
    <tr>
      <td colspan="5" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Archive Messages</td>
    </tr>
    <tr >
	  <td colspan="5" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;"><span class="partial-check">✔️</span> Host Address Verification</td>
    </tr>
    <tr >
	  <td colspan="1"</td>
      <td colspan="4" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Android Beta-App</td>
    </tr>
    <tr >
	  <td colspan="1"</td>
      <td colspan="4" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ iPhone Beta-App</td>
    </tr>
    <tr >
	  <td colspan="1"</td>
      <td colspan="4" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Dashboard Reminders</td>
    </tr>
    <tr >
	  <td colspan="1"</td>
    ...
    <tr >
	  <td colspan="2"</td>
	  <td colspan="3" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;"><span class="partial-check">✔️</span> iCal Events</td>
    </tr>
    <tr >
	  <td colspan="2"</td>
      <td colspan="3" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;"><span class="partial-check">✔️</span> Public Trips</td>
    </tr>
    <tr >
	  <td colspan="2"</td>
    ...
    <tr >
	  <td colspan="3"</td>
      <td colspan="2" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;">Feature Request Board</td>
    </tr>
	<!-- UPDATES -->
    <tr >
      <td rowspan="6" style="border: 0; padding: 8px; word-wrap: break-word; text-align: center; background-color: #FDE9D4; font-weight: bold; border-radius: 5px;">Updates</td>
    ...
    <tr >
	  <td colspan="1"</td>
      <td colspan="4" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Dashboard 2.0</td>
    </tr>
    <tr >
	  <td colspan="1"</td>
      <td colspan="4" style="border: 0; padding: 8px; color: #FFF; background: linear-gradient(to right, #20686C, #00A398, #FCFCFC); border-radius: 5px;">✅ Public Donations Page</td>
    </tr>
    <tr>
	  <td colspan="2"</td>
	...
	<tr >
	  <td colspan="1"</td>
	  <td colspan="4" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;"><span class="partial-check">✔️</span> Unified Moderation System</td>
    </tr>
    <tr >
	  <td colspan="1"</td>
    ...
    <tr>
	  <td colspan="2"</td>
	  <td colspan="3" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;">City Level Communities</td>
    </tr>
    <tr>
	  <td colspan="2"</td>
	  <td colspan="3" style="border: 0; padding: 8px; background: linear-gradient(to right, #FDE9D4, #FCFCFC); border-radius: 5px;">Onboarding Emails</td>
    </tr>
    </tr>
  </tbody>
</table>
