...
import { PostalVerificationPromiseClient } from "proto/postal_verification_grpc_web_pb";
...
const client = {
  ...
  postalVerification: new PostalVerificationPromiseClient(URL, null, opts),
