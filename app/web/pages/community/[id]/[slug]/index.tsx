...
import { COMMUNITIES, GLOBAL, MESSAGES, NOTIFICATIONS, PROFILE, PUBLIC_TRIPS } from "i18n/namespaces";
...
export default function CommunityPage() {
  ...
  return <CommunityPageComponent communityId={parsedId} tab={undefined} edit={undefined} />;
}
