...
import UserPageComponent from "features/mod/ModUserPage";
import NotFoundPage from "features/NotFoundPage";
import { appServerSideTranslations } from "i18n/appServerSideTranslations";
import { DEFAULT_LOCALE } from "i18n/locales";
import { CONNECTIONS, DASHBOARD, GLOBAL, MOD, NOTIFICATIONS, PROFILE } from "i18n/namespaces";
...
export const getStaticProps: GetStaticProps = async ({ locale }) => ({
  props: {
    ...(await appServerSideTranslations(locale ?? DEFAULT_LOCALE, [CONNECTIONS, DASHBOARD, GLOBAL, NOTIFICATIONS, PROFILE, MOD])),
  },
});
