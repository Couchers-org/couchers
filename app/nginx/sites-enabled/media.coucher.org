server {
    ...
    location = / {
        ...
        return 200 "This is the media server for the Couchers.org app. If you're interested in helping out in building the next-generation couch-surfing platform with us, please email us.";
    }
