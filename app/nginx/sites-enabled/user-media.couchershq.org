server {
    ...
    server_name user-media.couchershq.org;

    access_log /var/log/nginx/user-media.couchershq.org.access.log;
    error_log /var/log/nginx/user-media.couchershq.org.error.log;

    ssl_certificate /certs/live/user-media.couchershq.org/fullchain.pem;
    ssl_certificate_key /certs/live/user-media.couchershq.org/privkey.pem;
