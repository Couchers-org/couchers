server {
    ...
    server_name dev-api.couchershq.org;

    access_log /var/log/nginx/dev-api.couchershq.org.access.log;
    error_log /var/log/nginx/dev-api.couchershq.org.error.log;

    ssl_certificate /certs/live/dev-api.couchershq.org/fullchain.pem;
    ssl_certificate_key /certs/live/dev-api.couchershq.org/privkey.pem;
