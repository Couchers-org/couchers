...
export class HostRequestIndicateDidntMeetupReq extends jspb.Message {
  getHostRequestId(): number;
  setHostRequestId(value: number): HostRequestIndicateDidntMeetupReq;

  getReasonDidntMeetup(): string;
  setReasonDidntMeetup(value: string): HostRequestIndicateDidntMeetupReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): HostRequestIndicateDidntMeetupReq.AsObject;
  static toObject(includeInstance: boolean, msg: HostRequestIndicateDidntMeetupReq): HostRequestIndicateDidntMeetupReq.AsObject;
  static serializeBinaryToWriter(message: HostRequestIndicateDidntMeetupReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): HostRequestIndicateDidntMeetupReq;
  static deserializeBinaryFromReader(message: HostRequestIndicateDidntMeetupReq, reader: jspb.BinaryReader): HostRequestIndicateDidntMeetupReq;
}

export namespace HostRequestIndicateDidntMeetupReq {
  export type AsObject = {
    hostRequestId: number,
