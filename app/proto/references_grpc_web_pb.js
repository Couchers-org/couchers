 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.references.ListReferencesRes)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.references.Reference)}
 *     callback The callback function(error, response)
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.org.couchers.api.references.HostRequestIndicateDidntMeetupReq,
 *   !proto.google.protobuf.Empty>}
 */
const methodDescriptor_References_HostRequestIndicateDidntMeetup = new grpc.web.MethodDescriptor(
  '/org.couchers.api.references.References/HostRequestIndicateDidntMeetup',
  grpc.web.MethodType.UNARY,
  proto.org.couchers.api.references.HostRequestIndicateDidntMeetupReq,
  google_protobuf_empty_pb.Empty,
  /**
   * @param {!proto.org.couchers.api.references.HostRequestIndicateDidntMeetupReq} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.org.couchers.api.references.HostRequestIndicateDidntMeetupReq} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 ...
 *     The XHR Node Readable Stream
 */
proto.org.couchers.api.references.ReferencesClient.prototype.hostRequestIndicateDidntMeetup =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/org.couchers.api.references.References/HostRequestIndicateDidntMeetup',
      request,
      metadata || {},
      methodDescriptor_References_HostRequestIndicateDidntMeetup,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.org.couchers.api.references.ReferencesPromiseClient.prototype.hostRequestIndicateDidntMeetup =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/org.couchers.api.references.References/HostRequestIndicateDidntMeetup',
      request,
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.references.AvailableWriteReferencesRes)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.org.couchers.api.references.ListPendingReferencesToWriteRes)}
 *     callback The callback function(error, response)
