...
class ConversationsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDirectMessage = channel.unary_unary(
                ...
                request_serializer=pb_dot_conversations__pb2.GetDirectMessageReq.SerializeToString,
                response_deserializer=pb_dot_conversations__pb2.GroupChat.FromString,
                )
        ...
        self.RemoveGroupChatUser = channel.unary_unary(
                ...
                request_serializer=pb_dot_conversations__pb2.RemoveGroupChatUserReq.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                )
...
def add_ConversationsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetDirectMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pb_dot_conversations__pb2.GetDirectMessageReq.FromString,
                    response_serializer=pb_dot_conversations__pb2.GroupChat.SerializeToString,
            ),
            ...
            'RemoveGroupChatUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pb_dot_conversations__pb2.RemoveGroupChatUserReq.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class Conversations(object):
    ...
    def GetDirectMessage(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.conversations.Conversations/GetDirectMessage',
            pb_dot_conversations__pb2.GetDirectMessageReq.SerializeToString,
            pb_dot_conversations__pb2.GroupChat.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RemoveGroupChatUser(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.conversations.Conversations/RemoveGroupChatUser',
            pb_dot_conversations__pb2.RemoveGroupChatUserReq.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
