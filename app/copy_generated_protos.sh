...
rsync -a proto/gen/api/descriptors.pb backend/src/couchers/proto/descriptors.pb
rsync -ar proto/gen/api/python/ backend/src/couchers/proto/
rsync -ar proto/gen/backend/ backend/src/couchers/proto/
...
rsync -ar proto/gen/api/python/ client/src/couchers/proto/

# media
mkdir -p media/src/media/proto/
rsync -ar proto/gen/api/python/ media/src/media/proto/
...
# web
mkdir -p web/proto/
rsync -ar proto/gen/api/ts/ web/proto/

# mobile
mkdir -p mobile/proto/
rsync -ar proto/gen/api/ts/ mobile/proto/
