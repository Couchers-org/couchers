...
import { InitiateMediaUploadRes } from "couchers-core/src/proto/api_pb";
import { service } from "couchers-core/dist/service";
import client from "couchers-core/dist/service/client";
import {
  IMAGE_TOO_LARGE,
  INTERNAL_ERROR,
  SERVER_ERROR,
} from "couchers-core/dist/service/constants";
