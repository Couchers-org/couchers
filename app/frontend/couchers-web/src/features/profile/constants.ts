import {
  ...
  SmokingLocation,
  User,
} from "couchers-core/src/proto/api_pb";
import { ReferenceType } from "couchers-core/src/proto/references_pb";
import { ReferenceTypeState } from "couchers-core/dist/service/references";
...
export const referencesFilterLabels: Record<ReferenceTypeState, string> = {
