...
export function createDiscussion(title, content, ownerCommunityId, ownerGroupId) {
    return __awaiter(this, void 0, void 0, function () {
        var req, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req = new CreateDiscussionReq();
                    req.setTitle(title);
                    ...
                    return [4 /*yield*/, client.discussions.createDiscussion(req)];
                case 1:
                    response = _a.sent();
...
export function getDiscussion(discussionId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    req = new GetDiscussionReq();
                    req.setDiscussionId(discussionId);
                    return [4 /*yield*/, client.discussions.getDiscussion(req)];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.toObject()];
            }
