...
export function reportBug(_a) {
    var description = _a.description, results = _a.results, subject = _a.subject;
    return __awaiter(this, void 0, void 0, function () {
        var req, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    req = new ReportBugReq();
                    ...
                    return [4 /*yield*/, client.bugs.reportBug(req)];
                case 1:
                    res = _b.sent();
