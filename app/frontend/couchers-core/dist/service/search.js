...
export function userSearch(_a, pageToken) {
    var query = _a.query, lat = _a.lat, lng = _a.lng, radius = _a.radius, lastActive = _a.lastActive, hostingStatusOptions = _a.hostingStatusOptions, numGuests = _a.numGuests;
    if (pageToken === void 0) { pageToken = ""; }
    return __awaiter(this, void 0, void 0, function () {
        var req, area, timestamp, response;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (lat !== undefined && lng !== undefined) {
                        area = new Area().setLat(lat).setLng(lng);
                        if (radius) {
                    ...
                    return [4 /*yield*/, client.search.userSearch(req)];
                case 1:
                    response = _b.sent();
