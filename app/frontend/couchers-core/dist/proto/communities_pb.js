...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.api.communities.Community.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            parentsList: jspb.Message.toObjectList(msg.getParentsList(), groups_pb.Parent.toObject, includeInstance),
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 5:
                ...
                break;
            case 6:
                var value = new groups_pb.Parent;
                reader.readMessage(value, groups_pb.Parent.deserializeBinaryFromReader);
...
proto.org.couchers.api.communities.Community.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, groups_pb.Parent.serializeBinaryToWriter);
    }
...
proto.org.couchers.api.communities.Community.prototype.getParentsList = function () {
    return /** @type{!Array<!proto.org.couchers.api.groups.Parent>} */ (jspb.Message.getRepeatedWrapperField(this, groups_pb.Parent, 6));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.api.communities.ListCommunitiesRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            communitiesList: jspb.Message.toObjectList(msg.getCommunitiesList(), proto.org.couchers.api.communities.Community.toObject, includeInstance),
...
proto.org.couchers.api.communities.ListCommunitiesRes.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.org.couchers.api.communities.Community.serializeBinaryToWriter);
    }
...
proto.org.couchers.api.communities.ListCommunitiesRes.prototype.getCommunitiesList = function () {
    return /** @type{!Array<!proto.org.couchers.api.communities.Community>} */ (jspb.Message.getRepeatedWrapperField(this, proto.org.couchers.api.communities.Community, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.api.communities.ListGroupsRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            groupsList: jspb.Message.toObjectList(msg.getGroupsList(), groups_pb.Group.toObject, includeInstance),
            nextPageToken: jspb.Message.getFieldWithDefault(msg, 2, "")
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
...
proto.org.couchers.api.communities.ListGroupsRes.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, groups_pb.Group.serializeBinaryToWriter);
    }
    f = message.getNextPageToken();
    if (f.length > 0) {
        writer.writeString(2, f);
...
proto.org.couchers.api.communities.ListGroupsRes.prototype.getGroupsList = function () {
    return /** @type{!Array<!proto.org.couchers.api.groups.Group>} */ (jspb.Message.getRepeatedWrapperField(this, groups_pb.Group, 1));
};
/**
 ...
 * @return {boolean}
 */
proto.org.couchers.api.communities.ListEventsReq.prototype.getPast = function () {
 ...
 * @return {!proto.org.couchers.api.communities.ListEventsReq} returns this
 */
proto.org.couchers.api.communities.ListEventsReq.prototype.setPast = function (value) {
...
//# sourceMappingURL=communities_pb.js.map