...
proto.org.couchers.api.pages.Page.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getThread();
    if (f != null) {
        writer.writeMessage(20, f, threads_pb.Thread.serializeBinaryToWriter);
    }
    f = message.getTitle();
    if (f.length > 0) {
    ...
    if (f != null) {
        writer.writeMessage(14, f, proto.org.couchers.api.pages.Coordinate.serializeBinaryToWriter);
    }
...
proto.org.couchers.api.pages.Page.prototype.getThread = function () {
    return /** @type{?proto.org.couchers.api.threads.Thread} */ (jspb.Message.getWrapperField(this, threads_pb.Thread, 20));
};
/**
...
proto.org.couchers.api.pages.Page.prototype.getLocation = function () {
    return /** @type{?proto.org.couchers.api.pages.Coordinate} */ (jspb.Message.getWrapperField(this, proto.org.couchers.api.pages.Coordinate, 14));
};
/**
...
proto.org.couchers.api.pages.CreatePlaceReq.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getLocation();
    if (f != null) {
        writer.writeMessage(4, f, proto.org.couchers.api.pages.Coordinate.serializeBinaryToWriter);
    }
};
/**
...
proto.org.couchers.api.pages.CreatePlaceReq.prototype.getLocation = function () {
    return /** @type{?proto.org.couchers.api.pages.Coordinate} */ (jspb.Message.getWrapperField(this, proto.org.couchers.api.pages.Coordinate, 4));
};
/**
 * @param {?proto.org.couchers.api.pages.Coordinate|undefined} value
 * @return {!proto.org.couchers.api.pages.CreatePlaceReq} returns this
...
proto.org.couchers.api.pages.CreateGuideReq.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getLocation();
    if (f != null) {
        writer.writeMessage(5, f, proto.org.couchers.api.pages.Coordinate.serializeBinaryToWriter);
    }
};
/**
 * optional string title = 1;
...
proto.org.couchers.api.pages.CreateGuideReq.prototype.getLocation = function () {
    return /** @type{?proto.org.couchers.api.pages.Coordinate} */ (jspb.Message.getWrapperField(this, proto.org.couchers.api.pages.Coordinate, 5));
};
/**
 * @param {?proto.org.couchers.api.pages.Coordinate|undefined} value
 * @return {!proto.org.couchers.api.pages.CreateGuideReq} returns this
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.api.pages.ListUserPlacesRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            placesList: jspb.Message.toObjectList(msg.getPlacesList(), proto.org.couchers.api.pages.Page.toObject, includeInstance),
...
proto.org.couchers.api.pages.ListUserPlacesRes.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.org.couchers.api.pages.Page.serializeBinaryToWriter);
    }
...
proto.org.couchers.api.pages.ListUserPlacesRes.prototype.getPlacesList = function () {
    return /** @type{!Array<!proto.org.couchers.api.pages.Page>} */ (jspb.Message.getRepeatedWrapperField(this, proto.org.couchers.api.pages.Page, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.api.pages.ListUserGuidesRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            guidesList: jspb.Message.toObjectList(msg.getGuidesList(), proto.org.couchers.api.pages.Page.toObject, includeInstance),
            nextPageToken: jspb.Message.getFieldWithDefault(msg, 2, "")
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
...
//# sourceMappingURL=pages_pb.js.map