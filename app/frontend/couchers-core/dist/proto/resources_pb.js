...
goog.exportSymbol('proto.org.couchers.resources.CommunityGuideline', null, global);
goog.exportSymbol('proto.org.couchers.resources.GetCommunityGuidelinesRes', null, global);
 ...
 * @constructor
 */
proto.org.couchers.resources.CommunityGuideline = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.org.couchers.resources.CommunityGuideline, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
     */
    proto.org.couchers.resources.CommunityGuideline.displayName = 'proto.org.couchers.resources.CommunityGuideline';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes = function (opt_data) {
    jspb.Message.initialize(this, opt_data, 0, -1, proto.org.couchers.resources.GetCommunityGuidelinesRes.repeatedFields_, null);
};
goog.inherits(proto.org.couchers.resources.GetCommunityGuidelinesRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
    /**
     * @public
     * @override
     */
    proto.org.couchers.resources.GetCommunityGuidelinesRes.displayName = 'proto.org.couchers.resources.GetCommunityGuidelinesRes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.org.couchers.resources.CommunityGuideline.prototype.toObject = function (opt_includeInstance) {
        return proto.org.couchers.resources.CommunityGuideline.toObject(opt_includeInstance, this);
    };
    /**
     * Static version of the {@see toObject} method.
     * @param {boolean|undefined} includeInstance Deprecated. Whether to include
     *     the JSPB instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.org.couchers.resources.CommunityGuideline} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.org.couchers.resources.CommunityGuideline.toObject = function (includeInstance, msg) {
        var f, obj = {
            title: jspb.Message.getFieldWithDefault(msg, 1, ""),
            guideline: jspb.Message.getFieldWithDefault(msg, 2, ""),
            iconSvg: jspb.Message.getFieldWithDefault(msg, 3, "")
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.org.couchers.resources.CommunityGuideline}
 */
proto.org.couchers.resources.CommunityGuideline.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.org.couchers.resources.CommunityGuideline;
    return proto.org.couchers.resources.CommunityGuideline.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.org.couchers.resources.CommunityGuideline} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.org.couchers.resources.CommunityGuideline}
 */
proto.org.couchers.resources.CommunityGuideline.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break;
        }
        ...
        switch (field) {
            ...
            case 2:
                var value = /** @type {string} */ (reader.readString());
                msg.setGuideline(value);
                break;
            case 3:
                var value = /** @type {string} */ (reader.readString());
                msg.setIconSvg(value);
                break;
            default:
                reader.skipField();
                break;
 ...
 * @return {!Uint8Array}
 */
proto.org.couchers.resources.CommunityGuideline.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.org.couchers.resources.CommunityGuideline.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.org.couchers.resources.CommunityGuideline} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.org.couchers.resources.CommunityGuideline.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
    f = message.getTitle();
    if (f.length > 0) {
        writer.writeString(1, f);
    }
    f = message.getGuideline();
    if (f.length > 0) {
        writer.writeString(2, f);
    }
    f = message.getIconSvg();
    if (f.length > 0) {
 ...
 * @return {string}
 */
proto.org.couchers.resources.CommunityGuideline.prototype.getTitle = function () {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
/**
 * @param {string} value
 * @return {!proto.org.couchers.resources.CommunityGuideline} returns this
 */
proto.org.couchers.resources.CommunityGuideline.prototype.setTitle = function (value) {
    return jspb.Message.setProto3StringField(this, 1, value);
};
/**
 * optional string guideline = 2;
 * @return {string}
 */
proto.org.couchers.resources.CommunityGuideline.prototype.getGuideline = function () {
 ...
 * @return {!proto.org.couchers.resources.CommunityGuideline} returns this
 */
proto.org.couchers.resources.CommunityGuideline.prototype.setGuideline = function (value) {
    return jspb.Message.setProto3StringField(this, 2, value);
};
/**
 * optional string icon_svg = 3;
 * @return {string}
 */
proto.org.couchers.resources.CommunityGuideline.prototype.getIconSvg = function () {
 ...
 * @return {!proto.org.couchers.resources.CommunityGuideline} returns this
 */
proto.org.couchers.resources.CommunityGuideline.prototype.setIconSvg = function (value) {
 ...
 * @const
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.repeatedFields_ = [1];
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto.
     * Field names that are reserved in JavaScript and will be renamed to pb_name.
     ...
     * @return {!Object}
     */
    proto.org.couchers.resources.GetCommunityGuidelinesRes.prototype.toObject = function (opt_includeInstance) {
        return proto.org.couchers.resources.GetCommunityGuidelinesRes.toObject(opt_includeInstance, this);
    };
    /**
     * Static version of the {@see toObject} method.
     * @param {boolean|undefined} includeInstance Deprecated. Whether to include
     *     the JSPB instance for transitional soy proto support:
     *     http://goto/soy-param-migration
     * @param {!proto.org.couchers.resources.GetCommunityGuidelinesRes} msg The msg instance to transform.
     * @return {!Object}
     * @suppress {unusedLocalVariables} f is only used for nested messages
     */
    proto.org.couchers.resources.GetCommunityGuidelinesRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            communityGuidelinesList: jspb.Message.toObjectList(msg.getCommunityGuidelinesList(), proto.org.couchers.resources.CommunityGuideline.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.org.couchers.resources.GetCommunityGuidelinesRes}
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.deserializeBinary = function (bytes) {
    var reader = new jspb.BinaryReader(bytes);
    var msg = new proto.org.couchers.resources.GetCommunityGuidelinesRes;
    return proto.org.couchers.resources.GetCommunityGuidelinesRes.deserializeBinaryFromReader(msg, reader);
};
/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.org.couchers.resources.GetCommunityGuidelinesRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.org.couchers.resources.GetCommunityGuidelinesRes}
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.deserializeBinaryFromReader = function (msg, reader) {
    while (reader.nextField()) {
        if (reader.isEndGroup()) {
            break;
        }
        ...
        switch (field) {
            case 1:
                var value = new proto.org.couchers.resources.CommunityGuideline;
                reader.readMessage(value, proto.org.couchers.resources.CommunityGuideline.deserializeBinaryFromReader);
                msg.addCommunityGuidelines(value);
                break;
            default:
                reader.skipField();
                break;
 ...
 * @return {!Uint8Array}
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.prototype.serializeBinary = function () {
    var writer = new jspb.BinaryWriter();
    proto.org.couchers.resources.GetCommunityGuidelinesRes.serializeBinaryToWriter(this, writer);
    return writer.getResultBuffer();
};
/**
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.org.couchers.resources.GetCommunityGuidelinesRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.serializeBinaryToWriter = function (message, writer) {
    var f = undefined;
    f = message.getCommunityGuidelinesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.org.couchers.resources.CommunityGuideline.serializeBinaryToWriter);
    }
};
/**
 * repeated CommunityGuideline community_guidelines = 1;
 * @return {!Array<!proto.org.couchers.resources.CommunityGuideline>}
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.prototype.getCommunityGuidelinesList = function () {
    return /** @type{!Array<!proto.org.couchers.resources.CommunityGuideline>} */ (jspb.Message.getRepeatedWrapperField(this, proto.org.couchers.resources.CommunityGuideline, 1));
};
/**
 * @param {!Array<!proto.org.couchers.resources.CommunityGuideline>} value
 * @return {!proto.org.couchers.resources.GetCommunityGuidelinesRes} returns this
*/
proto.org.couchers.resources.GetCommunityGuidelinesRes.prototype.setCommunityGuidelinesList = function (value) {
    return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
/**
 * @param {!proto.org.couchers.resources.CommunityGuideline=} opt_value
 * @param {number=} opt_index
 * @return {!proto.org.couchers.resources.CommunityGuideline}
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.prototype.addCommunityGuidelines = function (opt_value, opt_index) {
    return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.org.couchers.resources.CommunityGuideline, opt_index);
};
/**
 * Clears the list making it empty but non-null.
 * @return {!proto.org.couchers.resources.GetCommunityGuidelinesRes} returns this
 */
proto.org.couchers.resources.GetCommunityGuidelinesRes.prototype.clearCommunityGuidelinesList = function () {
    return this.setCommunityGuidelinesList([]);
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto.
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.resources.GetRegionsRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            regionsList: jspb.Message.toObjectList(msg.getRegionsList(), proto.org.couchers.resources.Region.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.org.couchers.resources.GetRegionsRes.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.org.couchers.resources.Region.serializeBinaryToWriter);
    }
};
/**
...
proto.org.couchers.resources.GetRegionsRes.prototype.getRegionsList = function () {
    return /** @type{!Array<!proto.org.couchers.resources.Region>} */ (jspb.Message.getRepeatedWrapperField(this, proto.org.couchers.resources.Region, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.org.couchers.resources.GetLanguagesRes.toObject = function (includeInstance, msg) {
        var f, obj = {
            languagesList: jspb.Message.toObjectList(msg.getLanguagesList(), proto.org.couchers.resources.Language.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.org.couchers.resources.GetLanguagesRes.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.org.couchers.resources.Language.serializeBinaryToWriter);
    }
};
/**
...
proto.org.couchers.resources.GetLanguagesRes.prototype.getLanguagesList = function () {
    return /** @type{!Array<!proto.org.couchers.resources.Language>} */ (jspb.Message.getRepeatedWrapperField(this, proto.org.couchers.resources.Language, 1));
};
/**
...
//# sourceMappingURL=resources_pb.js.map