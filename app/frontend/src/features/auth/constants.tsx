...
export const INTRODUCTION_SUBTITLE = "Built by the community and always free. Be part of growing the platform by testing or volunteering";
export const INTRODUCTION_TITLE = "The new alternative to Couchsurfing™";
