...
We have had amazing experiences using Couchsurfing&#8482;. For many people, it brought them into communities and provided them with great interactions with other people. There is still a lot of love and loyalty for Couchsurfing&#8482;, even amongst the people working on this project. That being said, it definitely has its issues. Here, we go into a deep dive on those problems before addressing them in [our improvements](/about/solutions).
...
### [Profit incentives](/about/issues/profit-and-incentives) <span class="tag is-success">Governance</span>
...
### [Neglected communities and trust](/about/issues/communities-and-trust) <span class="tag is-success">Governance</span>
...
### [Safety issues and freeloaders](/about/issues/creeps-and-freeloaders) <span class="tag is-warning">Design</span>
...
### [The broken reference system](/about/issues/reviews) <span class="tag is-warning">Design</span>
...
### [The trend of super-hosts and few other active hosts](/about/issues/host-matching) <span class="tag is-warning">Design</span>
...
### [Poor functioning of the phone and web apps](/about/issues/the-build) <span class="tag is-danger">Technology</span>
