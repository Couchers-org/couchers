...
export const getBugReportSuccessMessage = (bugId: string) =>
  `Thank you for reporting that bug and making Couchers better, a report was sent to the developers! The bug ID is ${bugId}`;
