...
export class APIClient {
  ...
  ping(
    ...
    callback: (err: grpcWeb.Error, response: pb_api_pb.PingRes) => void
  ): grpcWeb.ClientReadableStream<pb_api_pb.PingRes>;

  getUser(
    request: pb_api_pb.GetUserReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: pb_api_pb.User) => void
  ...
  listFriendRequests(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_api_pb.ListFriendRequestsRes
    ) => void
  ...
  listFriends(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: pb_api_pb.ListFriendsRes) => void
  ...
  listMutualFriends(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_api_pb.ListMutualFriendsRes
    ) => void
  ...
  initiateMediaUpload(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_api_pb.InitiateMediaUploadRes
    ) => void
