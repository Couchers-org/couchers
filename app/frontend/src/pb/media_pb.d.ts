...
export class UploadConfirmationReq extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: UploadConfirmationReq): UploadConfirmationReq.AsObject;
  static serializeBinaryToWriter(message: UploadConfirmationReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UploadConfirmationReq;
  static deserializeBinaryFromReader(message: UploadConfirmationReq, reader: jspb.BinaryReader): UploadConfirmationReq;
}
