...
export class AuthClient {
  ...
  signup(
    ...
    callback: (err: grpcWeb.Error, response: pb_auth_pb.SignupRes) => void
  ...
  usernameValid(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_auth_pb.UsernameValidRes
    ) => void
  ...
  signupTokenInfo(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_auth_pb.SignupTokenInfoRes
    ) => void
  ...
  completeSignup(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: pb_auth_pb.AuthRes) => void
  ): grpcWeb.ClientReadableStream<pb_auth_pb.AuthRes>;

  login(
    request: pb_auth_pb.LoginReq,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: pb_auth_pb.LoginRes) => void
