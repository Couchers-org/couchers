...
export class EventsClient {
  ...
  createEvent(
    ...
    callback: (err: grpcWeb.Error, response: pb_events_pb.Event) => void
  ...
  listEventOccurrences(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_events_pb.ListEventOccurrencesRes
    ) => void
  ...
  listEventAttendees(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_events_pb.ListEventAttendeesRes
    ) => void
  ...
  listEventSubscribers(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_events_pb.ListEventSubscribersRes
    ) => void
  ...
  listEventOrganizers(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_events_pb.ListEventOrganizersRes
    ) => void
  ...
  listMyEvents(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_events_pb.ListMyEventsRes
    ) => void
