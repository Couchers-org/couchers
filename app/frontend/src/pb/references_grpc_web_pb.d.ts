...
export class ReferencesClient {
  ...
  listReferences(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_references_pb.ListReferencesRes
    ) => void
  ...
  writeFriendReference(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: pb_references_pb.Reference) => void
  ...
  availableWriteReferences(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_references_pb.AvailableWriteReferencesRes
    ) => void
  ...
  listPendingReferencesToWrite(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_references_pb.ListPendingReferencesToWriteRes
    ) => void
