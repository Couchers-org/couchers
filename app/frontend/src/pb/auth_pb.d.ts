...
export class UsernameValidReq extends jspb.Message {
  ...
  static toObject(
    ...
    msg: UsernameValidReq
  ): UsernameValidReq.AsObject;
  static serializeBinaryToWriter(
...
export class UsernameValidRes extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UsernameValidRes
  ): UsernameValidRes.AsObject;
  static serializeBinaryToWriter(
...
export class SignupTokenInfoReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: SignupTokenInfoReq
  ): SignupTokenInfoReq.AsObject;
  static serializeBinaryToWriter(
...
export class SignupTokenInfoRes extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: SignupTokenInfoRes
  ): SignupTokenInfoRes.AsObject;
  static serializeBinaryToWriter(
...
export class CompleteSignupReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CompleteSignupReq
  ): CompleteSignupReq.AsObject;
  static serializeBinaryToWriter(
...
export class CompleteTokenLoginReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CompleteTokenLoginReq
  ): CompleteTokenLoginReq.AsObject;
  static serializeBinaryToWriter(
...
export class ResetPasswordReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ResetPasswordReq
  ): ResetPasswordReq.AsObject;
  static serializeBinaryToWriter(
...
export class CompletePasswordResetReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CompletePasswordResetReq
  ): CompletePasswordResetReq.AsObject;
  static serializeBinaryToWriter(
...
export class CompleteChangeEmailReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CompleteChangeEmailReq
  ): CompleteChangeEmailReq.AsObject;
  static serializeBinaryToWriter(
