...
export class ListReferencesReq extends jspb.Message {
  ...
  static toObject(
    ...
    msg: ListReferencesReq
  ): ListReferencesReq.AsObject;
  static serializeBinaryToWriter(
...
export class WriteFriendReferenceReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: WriteFriendReferenceReq
  ): WriteFriendReferenceReq.AsObject;
  static serializeBinaryToWriter(
...
export class WriteHostRequestReferenceReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: WriteHostRequestReferenceReq
  ): WriteHostRequestReferenceReq.AsObject;
  static serializeBinaryToWriter(
...
export class AvailableWriteReferencesReq extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: AvailableWriteReferencesReq
  ): AvailableWriteReferencesReq.AsObject;
  static serializeBinaryToWriter(
...
export class AvailableWriteReferenceType extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: AvailableWriteReferenceType
  ): AvailableWriteReferenceType.AsObject;
  static serializeBinaryToWriter(
...
export class AvailableWriteReferencesRes extends jspb.Message {
  ...
  setAvailableWriteReferencesList(
    value: Array<AvailableWriteReferenceType>
  ): AvailableWriteReferencesRes;
  clearAvailableWriteReferencesList(): AvailableWriteReferencesRes;
  addAvailableWriteReferences(
    value?: AvailableWriteReferenceType,
    index?: number
  ): AvailableWriteReferenceType;
  ...
  static toObject(
    includeInstance: boolean,
    msg: AvailableWriteReferencesRes
...
export class ListPendingReferencesToWriteRes extends jspb.Message {
  ...
  setPendingReferencesList(
    value: Array<AvailableWriteReferenceType>
  ): ListPendingReferencesToWriteRes;
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListPendingReferencesToWriteRes
  ): ListPendingReferencesToWriteRes.AsObject;
  static serializeBinaryToWriter(
