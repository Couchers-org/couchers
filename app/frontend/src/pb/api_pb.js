...
goog.exportSymbol('proto.api.MutualFriend', null, global);
 ...
 * @constructor
 */
proto.api.MutualFriend = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.MutualFriend, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.MutualFriend.displayName = 'proto.api.MutualFriend';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api.MutualFriend.prototype.toObject = function(opt_includeInstance) {
  return proto.api.MutualFriend.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.MutualFriend} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.MutualFriend.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, 0),
    username: jspb.Message.getFieldWithDefault(msg, 2, ""),
    name: jspb.Message.getFieldWithDefault(msg, 3, "")
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.MutualFriend}
 */
proto.api.MutualFriend.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.MutualFriend;
  return proto.api.MutualFriend.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.MutualFriend} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.MutualFriend}
 */
proto.api.MutualFriend.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.MutualFriend.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.MutualFriend.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.MutualFriend} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api.MutualFriend.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.api.MutualFriend.prototype.getUserId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.api.MutualFriend} returns this
 */
proto.api.MutualFriend.prototype.setUserId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.api.MutualFriend.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.api.MutualFriend} returns this
 */
proto.api.MutualFriend.prototype.setUsername = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.api.MutualFriend.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.api.MutualFriend} returns this
 */
proto.api.MutualFriend.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @const
 */
proto.api.User.repeatedFields_ = [16,17,18,20];
...
proto.api.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    occupation: jspb.Message.getFieldWithDefault(msg, 13, ""),
    aboutMe: jspb.Message.getFieldWithDefault(msg, 14, ""),
    aboutPlace: jspb.Message.getFieldWithDefault(msg, 15, ""),
    languagesList: (f = jspb.Message.getRepeatedField(msg, 16)) == null ? undefined : f,
    countriesVisitedList: (f = jspb.Message.getRepeatedField(msg, 17)) == null ? undefined : f,
    countriesLivedList: (f = jspb.Message.getRepeatedField(msg, 18)) == null ? undefined : f,
    friends: jspb.Message.getFieldWithDefault(msg, 19, 0),
    mutualFriendsList: jspb.Message.toObjectList(msg.getMutualFriendsList(),
    proto.api.MutualFriend.toObject, includeInstance)
  };
...
proto.api.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 19:
      ...
      break;
    case 20:
      var value = new proto.api.MutualFriend;
      reader.readMessage(value,proto.api.MutualFriend.deserializeBinaryFromReader);
...
proto.api.User.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      20,
      f,
      proto.api.MutualFriend.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional string about_place = 15;
 * @return {string}
 */
...
/**
 * optional FriendshipStatus friends = 19;
 * @return {!proto.api.User.FriendshipStatus}
 */
proto.api.User.prototype.getFriends = function() {
  return /** @type {!proto.api.User.FriendshipStatus} */ (jspb.Message.getFieldWithDefault(this, 19, 0));
};
 ...
 * @return {!Array<!proto.api.MutualFriend>}
 */
proto.api.User.prototype.getMutualFriendsList = function() {
  return /** @type{!Array<!proto.api.MutualFriend>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.api.MutualFriend, 20));
};


/**
 * @param {!Array<!proto.api.MutualFriend>} value
 * @return {!proto.api.User} returns this
*/
proto.api.User.prototype.setMutualFriendsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 20, value);
};


/**
 * @param {!proto.api.MutualFriend=} opt_value
 * @param {number=} opt_index
 * @return {!proto.api.MutualFriend}
 */
proto.api.User.prototype.addMutualFriends = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 20, opt_value, proto.api.MutualFriend, opt_index);
};
 ...
 * @return {!proto.api.User} returns this
 */
proto.api.User.prototype.clearMutualFriendsList = function() {
