...
goog.exportSymbol('proto.api.ListMutualFriendsReq', null, global);
goog.exportSymbol('proto.api.ListMutualFriendsRes', null, global);
 ...
 * @constructor
 */
proto.api.ListMutualFriendsReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api.ListMutualFriendsReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.ListMutualFriendsReq.displayName = 'proto.api.ListMutualFriendsReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.api.ListMutualFriendsRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.api.ListMutualFriendsRes.repeatedFields_, null);
};
goog.inherits(proto.api.ListMutualFriendsRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api.ListMutualFriendsRes.displayName = 'proto.api.ListMutualFriendsRes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api.ListMutualFriendsReq.prototype.toObject = function(opt_includeInstance) {
  return proto.api.ListMutualFriendsReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.ListMutualFriendsReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.ListMutualFriendsReq}
 */
proto.api.ListMutualFriendsReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.ListMutualFriendsReq;
  return proto.api.ListMutualFriendsReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.ListMutualFriendsReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.ListMutualFriendsReq}
 */
proto.api.ListMutualFriendsReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.ListMutualFriendsReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.ListMutualFriendsReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.ListMutualFriendsReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @const
 */
proto.api.ListMutualFriendsRes.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.api.ListMutualFriendsRes.prototype.toObject = function(opt_includeInstance) {
  return proto.api.ListMutualFriendsRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api.ListMutualFriendsRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api.ListMutualFriendsRes}
 */
proto.api.ListMutualFriendsRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api.ListMutualFriendsRes;
  return proto.api.ListMutualFriendsRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api.ListMutualFriendsRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api.ListMutualFriendsRes}
 */
proto.api.ListMutualFriendsRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api.ListMutualFriendsRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api.ListMutualFriendsRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api.ListMutualFriendsRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
