...
export class GroupsClient {
  ...
  getGroup(
    ...
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.Group) => void
  ...
  listAdmins(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListAdminsRes) => void
  ...
  listMembers(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListMembersRes) => void
  ...
  listPlaces(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListPlacesRes) => void
  ...
  listGuides(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListGuidesRes) => void
  ...
  listEvents(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListEventsRes) => void
  ...
  listDiscussions(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListDiscussionsRes) => void
  ...
  listUserGroups(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_groups_pb.ListUserGroupsRes) => void
