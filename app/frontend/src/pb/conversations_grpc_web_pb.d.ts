...
export class ConversationsClient {
  ...
  listGroupChats(
    ...
    callback: (err: grpcWeb.Error,
               response: pb_conversations_pb.ListGroupChatsRes) => void
  ...
  getGroupChat(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_conversations_pb.GroupChat) => void
  ...
  getUpdates(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_conversations_pb.GetUpdatesRes) => void
  ...
  getGroupChatMessages(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_conversations_pb.GetGroupChatMessagesRes) => void
  ...
  searchMessages(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_conversations_pb.SearchMessagesRes) => void
