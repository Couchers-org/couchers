...
export class CommunitiesClient {
  ...
  getCommunity(
    ...
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.Community) => void
  ...
  listCommunities(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListCommunitiesRes) => void
  ...
  listGroups(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListGroupsRes) => void
  ...
  listAdmins(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListAdminsRes) => void
  ...
  listMembers(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListMembersRes) => void
  ...
  listNearbyUsers(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListNearbyUsersRes) => void
  ...
  listPlaces(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListPlacesRes) => void
  ...
  listGuides(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListGuidesRes) => void
  ...
  listEvents(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListEventsRes) => void
  ...
  listDiscussions(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListDiscussionsRes) => void
  ...
  listUserCommunities(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error,
               response: pb_communities_pb.ListUserCommunitiesRes) => void
