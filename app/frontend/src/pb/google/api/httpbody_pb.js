// source: pb/google/api/httpbody.proto
/**
 * @fileoverview
 * @enhanceable
...
proto.google.api.HttpBody = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.google.api.HttpBody.repeatedFields_,
    null
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.google.api.HttpBody.prototype.toObject = function (
    opt_includeInstance
  ) {
 ...
 */
proto.google.api.HttpBody.prototype.addExtensions = function (
  opt_value,
  opt_index
) {
