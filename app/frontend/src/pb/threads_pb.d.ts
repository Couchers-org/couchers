...
export class GetThreadReq extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: GetThreadReq): GetThreadReq.AsObject;
  static serializeBinaryToWriter(message: GetThreadReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetThreadReq;
  static deserializeBinaryFromReader(message: GetThreadReq, reader: jspb.BinaryReader): GetThreadReq;
}
...
export class GetThreadRes extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: GetThreadRes): GetThreadRes.AsObject;
  static serializeBinaryToWriter(message: GetThreadRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetThreadRes;
  static deserializeBinaryFromReader(message: GetThreadRes, reader: jspb.BinaryReader): GetThreadRes;
}
...
export class PostReplyReq extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: PostReplyReq): PostReplyReq.AsObject;
  static serializeBinaryToWriter(message: PostReplyReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PostReplyReq;
  static deserializeBinaryFromReader(message: PostReplyReq, reader: jspb.BinaryReader): PostReplyReq;
}
...
export class PostReplyRes extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: PostReplyRes): PostReplyRes.AsObject;
  static serializeBinaryToWriter(message: PostReplyRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PostReplyRes;
  static deserializeBinaryFromReader(message: PostReplyRes, reader: jspb.BinaryReader): PostReplyRes;
}
