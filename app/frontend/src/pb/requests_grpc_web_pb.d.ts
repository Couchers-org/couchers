...
export class RequestsClient {
  ...
  createHostRequest(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_requests_pb.CreateHostRequestRes
    ) => void
  ...
  getHostRequest(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.Error, response: pb_requests_pb.HostRequest) => void
  ...
  listHostRequests(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_requests_pb.ListHostRequestsRes
    ) => void
  ...
  getHostRequestMessages(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_requests_pb.GetHostRequestMessagesRes
    ) => void
  ...
  getHostRequestUpdates(
    ...
    callback: (
      err: grpcWeb.Error,
      response: pb_requests_pb.GetHostRequestUpdatesRes
    ) => void
