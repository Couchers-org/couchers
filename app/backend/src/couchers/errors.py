...
EVENT_CANT_UPDATE_CANCELLED_EVENT = "You can't update, subscribe, or attend an event that's been cancelled."
EVENT_CANT_UPDATE_OLD_EVENT = "You can't update an event that's more than 1 day old."
EVENT_COMMUNITY_INVITE_ALREADY_ALREADY_DECIDED = "That event community invite was already approved/denied."
EVENT_COMMUNITY_INVITE_ALREADY_APPROVED = "A community invite has already been sent out for this event."
EVENT_COMMUNITY_INVITE_ALREADY_NOT_FOUND = "Couldn't find that event community invite."
