from couchers.constants import RATE_LIMIT_INTERVAL_STRING
...
CHAT_INITIATION_RATE_LIMIT = f"You have messaged a lot of users in the past {RATE_LIMIT_INTERVAL_STRING}. ""To avoid spam, you can't contact any more users for today."  # fmt: skip
...
FRIEND_REQUEST_RATE_LIMIT = f"You have sent a lot of friend requests in the past {RATE_LIMIT_INTERVAL_STRING}. To avoid spam, you can't send any more for today."  # fmt: skip
...
HOST_REQUEST_RATE_LIMIT = f"You have sent a lot of host requests in the past {RATE_LIMIT_INTERVAL_STRING}. To avoid spam, you can't send any more for today."  # fmt: skip
