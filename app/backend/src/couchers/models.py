...
class HostRequest(Base):
    ...
    is_host_archived = Column(Boolean, nullable=False, default=False, server_default=text("0"))
    is_surfer_archived = Column(Boolean, nullable=False, default=False, server_default=text("0"))
