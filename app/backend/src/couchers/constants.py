...
HOST_REQUEST_DAILY_BLOCKING_QUOTA = 80
FRIEND_REQUEST_DAILY_WARNING_QUOTA = 10
FRIEND_REQUEST_DAILY_BLOCKING_QUOTA = 40
CHAT_INITIATION_DAILY_WARNING_QUOTA = 15
CHAT_INITIATION_DAILY_BLOCKING_QUOTA = 150
