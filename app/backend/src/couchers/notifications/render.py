...
def render_notification(user: User, notification: Notification) -> RenderedNotification:
    ...
    elif notification.topic_action.display == "postal_verification:postcard_sent":
    ...
    elif notification.topic_action.display == "postal_verification:success":
    ...
    elif notification.topic_action.display == "postal_verification:failed":
