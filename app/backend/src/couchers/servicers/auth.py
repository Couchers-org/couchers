...
from couchers.utils import create_coordinate, create_session_cookie, now, parse_date, parse_session_cookie, today, required_birthdate
...
class Auth(auth_pb2_grpc.AuthServicer):
    ...
    def CompleteSignup(self, request, context):
        ...
        with session_scope() as session:
            ...
            if not birthdate or birthdate >= required_birthdate():
