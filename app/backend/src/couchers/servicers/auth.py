...
class Auth(auth_pb2_grpc.AuthServicer):
    ...
    @with_session
    def get_session_for_token(self, token, session):
        """
    ...
    @with_session
    def _delete_session(self, token, session):
        """
    ...
    @with_session
    def SignupTokenInfo(self, request, context, session):
        """
    ...
    @with_session
    def CompleteSignup(self, request, context, session):
        """
    ...
    @with_session
    def Login(self, request, context, session):
        """
    ...
    @with_session
    def CompleteTokenLogin(self, request, context, session):
        """
    ...
    @with_session
    def CompletePasswordReset(self, request, context, session):
        """
    ...
    @with_session
    def CompleteChangeEmail(self, request, context, session):
        """
