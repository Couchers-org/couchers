...
Revision ID: 03cefb74b370
Revises: 8b6297128973
Create Date: 2020-12-27 16:27:13.938188
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "state",
            sa.Enum("pending", "working", "completed", "error", "failed", name="backgroundjobstate"),
            nullable=False,
        ),
