...
def upgrade():
    ...
    op.add_column("host_requests", sa.Column("hosting_lat", sa.Float(), nullable=True))
    op.add_column("host_requests", sa.Column("hosting_lng", sa.Float(), nullable=True))
    op.add_column("host_requests", sa.Column("hosting_radius", sa.Float(), nullable=True))


def downgrade():
    op.drop_column("host_requests", "hosting_radius")
    op.drop_column("host_requests", "hosting_lng")
    op.drop_column("host_requests", "hosting_lat")
