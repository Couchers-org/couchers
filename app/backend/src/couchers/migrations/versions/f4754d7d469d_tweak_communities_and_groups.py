"""Tweak communities and groups

Revision ID: f4754d7d469d
Revises: cce0606c2f41
Create Date: 2021-01-11 13:05:06.946325
...
def upgrade():
    ...
    op.add_column("clusters", sa.Column("official_cluster_for_node_id", sa.BigInteger(), nullable=True))
