...
Revision ID: f2eb70a15400
Revises: 
Create Date: 2021-02-25 17:55:07.422135
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("from_user_id", "to_user_id", "reference_type", name=op.f("uq_references_from_user_id")),
    )
