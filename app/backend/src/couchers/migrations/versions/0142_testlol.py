...
def downgrade() -> None:
    op.alter_column("postal_verification_attemptsasdf", "country_code", new_column_name="country")
    op.drop_column("postal_verification_attemptsasdf", "mypostcard_job_id")
