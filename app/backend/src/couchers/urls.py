...
def strong_verification_complete_url(*, verification_attempt_token):
    return f"{config['BASE_URL']}/strong-verification-complete?verification_attempt_token={verification_attempt_token}"
