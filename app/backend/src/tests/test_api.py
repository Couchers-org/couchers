...
def test_user_model_to_pb_ghost_user(db, flag):
    ...
    assert user_pb.username == "deactivated-account"
    ...
    assert lite_user_pb.username == "deactivated-account"
...
def test_GetLiteUsers(db):
    ...
    with api_session(token1) as api:
        ...
        assert res.responses[8].user.username == "deactivated-account"
...
def test_GetLiteUser_ghost_user_by_username(db, flag):
    ...
    with api_session(token1) as api:
        ...
        assert lite_user.username == "deactivated-account"
...
def test_GetLiteUsers_ghost_users(db, flag):
    ...
    with api_session(token1) as api:
        ...
        assert res.responses[1].user.username == "deactivated-account"
        ...
        assert res.responses[3].user.username == "deactivated-account"
...
def test_GetLiteUsers_blocked_users(db):
    ...
    with api_session(token1) as api:
        ...
        assert res.responses[0].user.username == "deactivated-account"
        ...
        assert res.responses[2].user.username == "deactivated-account"
