...
def test_one_time_donation_flow(db, monkeypatch):
    ...
    with session_scope() as session:
        ...
        assert invoice.invoice_type == InvoiceType.on_platform
        assert (
...
def test_merch_invoice_flow(db, monkeypatch):
    ...
    with session_scope() as session:
        ...
        assert invoice.invoice_type == InvoiceType.external_shop
        ...
        # Check no donation notification was sent for external shop purchases
