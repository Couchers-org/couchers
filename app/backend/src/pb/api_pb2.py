...
_FRIENDREQUESTSTATUS = _descriptor.EnumDescriptor(
  name='FriendRequestStatus',
  full_name='api.FriendRequestStatus',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_FRIENDREQUESTSTATUS)

FriendRequestStatus = enum_type_wrapper.EnumTypeWrapper(_FRIENDREQUESTSTATUS)
PENDING = 0
ACCEPTED = 1
REJECTED = 2
...
_FRIENDREQUEST.fields_by_name['state'].enum_type = _FRIENDREQUESTSTATUS
...
DESCRIPTOR.enum_types_by_name['FriendRequestStatus'] = _FRIENDREQUESTSTATUS
