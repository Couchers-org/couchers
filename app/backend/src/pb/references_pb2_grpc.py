...
from pb import references_pb2 as pb_dot_references__pb2
...
class ReferencesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListReferences = channel.unary_unary(
                ...
                request_serializer=pb_dot_references__pb2.ListReferencesReq.SerializeToString,
                response_deserializer=pb_dot_references__pb2.ListReferencesRes.FromString,
                )
        self.WriteFriendReference = channel.unary_unary(
                '/org.couchers.api.references.References/WriteFriendReference',
                request_serializer=pb_dot_references__pb2.WriteFriendReferenceReq.SerializeToString,
                response_deserializer=pb_dot_references__pb2.Reference.FromString,
                )
        self.WriteHostRequestReference = channel.unary_unary(
                '/org.couchers.api.references.References/WriteHostRequestReference',
                request_serializer=pb_dot_references__pb2.WriteHostRequestReferenceReq.SerializeToString,
                response_deserializer=pb_dot_references__pb2.Reference.FromString,
                )
        self.AvailableWriteReferences = channel.unary_unary(
                '/org.couchers.api.references.References/AvailableWriteReferences',
                request_serializer=pb_dot_references__pb2.AvailableWriteReferencesReq.SerializeToString,
                response_deserializer=pb_dot_references__pb2.AvailableWriteReferencesRes.FromString,
                )
        self.ListPendingReferencesToWrite = channel.unary_unary(
                ...
                response_deserializer=pb_dot_references__pb2.ListPendingReferencesToWriteRes.FromString,
                )
...
class ReferencesServicer(object):
    ...
    def WriteHostRequestReference(self, request, context):
        """Write a reference for someone after having hosted/surfed with them. Raises NOT_FOUND if the request doesn't exist.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ReferencesServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListReferences': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=pb_dot_references__pb2.ListReferencesReq.FromString,
                    response_serializer=pb_dot_references__pb2.ListReferencesRes.SerializeToString,
            ),
            'WriteFriendReference': grpc.unary_unary_rpc_method_handler(
                    servicer.WriteFriendReference,
                    request_deserializer=pb_dot_references__pb2.WriteFriendReferenceReq.FromString,
                    response_serializer=pb_dot_references__pb2.Reference.SerializeToString,
            ),
            'WriteHostRequestReference': grpc.unary_unary_rpc_method_handler(
                    servicer.WriteHostRequestReference,
                    request_deserializer=pb_dot_references__pb2.WriteHostRequestReferenceReq.FromString,
                    response_serializer=pb_dot_references__pb2.Reference.SerializeToString,
            ),
            'AvailableWriteReferences': grpc.unary_unary_rpc_method_handler(
                    servicer.AvailableWriteReferences,
                    request_deserializer=pb_dot_references__pb2.AvailableWriteReferencesReq.FromString,
                    response_serializer=pb_dot_references__pb2.AvailableWriteReferencesRes.SerializeToString,
            ),
            'ListPendingReferencesToWrite': grpc.unary_unary_rpc_method_handler(
                    servicer.ListPendingReferencesToWrite,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=pb_dot_references__pb2.ListPendingReferencesToWriteRes.SerializeToString,
            ),
    }
...
class References(object):
    ...
    def ListReferences(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.references.References/ListReferences',
            pb_dot_references__pb2.ListReferencesReq.SerializeToString,
            pb_dot_references__pb2.ListReferencesRes.FromString,
    ...
    def WriteFriendReference(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.references.References/WriteFriendReference',
            pb_dot_references__pb2.WriteFriendReferenceReq.SerializeToString,
            pb_dot_references__pb2.Reference.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def WriteHostRequestReference(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.references.References/WriteHostRequestReference',
            pb_dot_references__pb2.WriteHostRequestReferenceReq.SerializeToString,
            pb_dot_references__pb2.Reference.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def AvailableWriteReferences(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.references.References/AvailableWriteReferences',
            pb_dot_references__pb2.AvailableWriteReferencesReq.SerializeToString,
            pb_dot_references__pb2.AvailableWriteReferencesRes.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ListPendingReferencesToWrite(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/org.couchers.api.references.References/ListPendingReferencesToWrite',
            ...
            pb_dot_references__pb2.ListPendingReferencesToWriteRes.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
